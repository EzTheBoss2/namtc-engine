...
global.openDoorButton[0] = ini_read_real("Controls","Open_door",ord("A"));
...
if (global.controllerEnabled)
{
    ...
    global.openDoorButton[1] = ini_read_real("Controller","Align_left",gp_shoulderl);
}
...
// NAMTG SPECIFIC CONFIGS
global.screenPosition = ini_read_real("NAMTC", "screenpos", 0)
